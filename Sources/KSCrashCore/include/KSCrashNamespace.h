...
#define KSCrashAppStateTrackerObserving KSCRASH_NS(KSCrashAppStateTrackerObserving)
...
#define KSCrashReportFilter KSCRASH_NS(KSCrashReportFilter)
...
#define KSCrashRunFilter KSCRASH_NS(KSCrashRunFilter)
...
#define KSCrashRunSummarySessionCounts KSCRASH_NS(KSCrashRunSummarySessionCounts)
#define KSCrashRunSummarySessionUser KSCRASH_NS(KSCrashRunSummarySessionUser)
...
#define KSCrashSessionLog KSCRASH_NS(KSCrashSessionLog)
...
#define SessionLog KSCRASH_NS(SessionLog)
...
#define kscrash_testcode_deriveReportsSiblingDir KSCRASH_NS(kscrash_testcode_deriveReportsSiblingDir)
...
#define ksruncontext_testcode_buildSummaryWithSessions KSCRASH_NS(ksruncontext_testcode_buildSummaryWithSessions)
