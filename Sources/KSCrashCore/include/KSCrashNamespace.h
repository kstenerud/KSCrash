...
#define kscm_machexception_setExceptionMask KSCRASH_NS(kscm_machexception_setExceptionMask)
...
#define kscm_testcode_restoreState KSCRASH_NS(kscm_testcode_restoreState)
#define kscm_testcode_saveState KSCRASH_NS(kscm_testcode_saveState)
...
#define kscma_hasRequiredCallbacks KSCRASH_NS(kscma_hasRequiredCallbacks)
...
#define kscmr_testcode_setDuplicateIdAsserts KSCRASH_NS(kscmr_testcode_setDuplicateIdAsserts)
...
#define kscrash_getPreviousTerminationReason KSCRASH_NS(kscrash_getPreviousTerminationReason)
#define kscrash_getReportStoreConfiguration KSCRASH_NS(kscrash_getReportStoreConfiguration)
...
#define kscrs_extractReportIdFromReportBytes KSCRASH_NS(kscrs_extractReportIdFromReportBytes)
#define kscrs_extractReportIdFromReportFile KSCRASH_NS(kscrs_extractReportIdFromReportFile)
...
#define kshang_fireHangEvent KSCRASH_NS(kshang_fireHangEvent)
#define kshang_isEnabled KSCRASH_NS(kshang_isEnabled)
#define kshang_setHangEventCallback KSCRASH_NS(kshang_setHangEventCallback)
#define ksid_generate KSCRASH_NS(ksid_generate)
#define ksid_isValid KSCRASH_NS(ksid_isValid)
...
#define ksjson_addFloatElement KSCRASH_NS(ksjson_addFloatElement)
...
#define kslifecycle_noteHangChange KSCRASH_NS(kslifecycle_noteHangChange)
...
#define kssession_copyUtf8Truncated KSCRASH_NS(kssession_copyUtf8Truncated)
