...
#define kscm_setSummarySidecarPathProvider KSCRASH_NS(kscm_setSummarySidecarPathProvider)
...
#define kscrs_reclaimOrphanedRunData KSCRASH_NS(kscrs_reclaimOrphanedRunData)
...
#define kssession_testcode_appendRawEntry KSCRASH_NS(kssession_testcode_appendRawEntry)
...
#define kssw_close KSCRASH_NS(kssw_close)
#define kssw_current KSCRASH_NS(kssw_current)
#define kssw_open KSCRASH_NS(kssw_open)
#define kssw_update KSCRASH_NS(kssw_update)
#define kssw_updatePerceptible KSCRASH_NS(kssw_updatePerceptible)
#define kssw_updateUser KSCRASH_NS(kssw_updateUser)
