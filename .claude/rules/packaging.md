...
The public API surface consists of these modules: **KSCrashRecording**, **KSCrashDiskMonitor**, **KSCrashBootMonitor**, and the Swift modules (**KSCrash**, **KSCrashReportModel**, **KSCrashMonitors**, **KSCrashProfiler**). Public headers live in `Sources/[ModuleName]/include/*.h`.
