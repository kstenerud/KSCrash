...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: Targets.crashDecoding,
            resources: [
                .copy("Resources/PrivacyInfo.xcprivacy")
            ]
        ),
        .testTarget(
            name: Targets.crashDecoding.tests,
            dependencies: [
                .target(name: Targets.crashDecoding)
            ],
            resources: [
                .process("Resources")
            ]
...
enum Targets {
    ...
    static let crashDecoding = "KSCrashDecoding"
